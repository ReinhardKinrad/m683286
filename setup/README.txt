...
IV. ЗАКЛЮЧИТЕЛЬНЫЙ ЭТАП
   ...
   В проекте используется плагин мавена, tomcat7, позволяющий производить деплой на удаленный сервер.
   ...
   После первого деплоя следует выполнить третий пункт скрипта установки Tomcat
